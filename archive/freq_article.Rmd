...
## transform to long
freq_dt_qu <- melt(freq_dt_qu[grepl('KW', as.character(quarter)), -'year'], id.vars = 'quarter')[, value := as.numeric(value)]
...
system.time(
    out_gibbs <- gibbs_est(y_qu, a.theta=1, b.theta=100, n.sample = 10, thin = 1, save.states = TRUE)
)
