...
ar_test <- auto.arima(diff(y_m, 1))

adf.test(diff(y_m, 1), alternative = "stationary")

plot(forecast(ar_test), include = 12)
...
ggplot(data.table(log(freq_filt[[mod]]$f), t = time(y_m)), aes(t, V1)) +
    geom_line() +
    theme_bw()
