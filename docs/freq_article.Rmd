...
test <- mod_gibbs(y_qu, a.y = 1, b.y = 1000, a.theta=1, b.theta=1000, n.sample = 1, thin = 1, save.states = TRUE)
...
for (mod in c('local_level', 'local_trend', 'lt_fourier', 'lt_arma', 'lt_arma_2')) {
    ...
    if (mod == 'lt_arma' | mod == 'lt_arma_2') {
        fit_full[[mod]] <- dlmMLE(y_qu, parm=c(-3, -3, -4, -5, 1, 0, -2), type = mod, build=mod_mle)
    }    
